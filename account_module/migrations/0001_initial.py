    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='images/user_avatar', verbose_name='آواتار')),
                ('email_active_code', models.CharField(max_length=100, verbose_name='کد فعالسازی')),
                ('about_user', models.CharField(blank=True, max_length=100, null=True, verbose_name='درباره کاربر')),
